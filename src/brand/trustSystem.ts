...
export const STATUS_TRANSITIONS: Record<BookingStatus, BookingStatus[]> = {
  requested: ["matching", "scheduled", "assigned", "cancelled"],
  matching: ["awaiting_partner_confirmation", "assigned", "cancelled"],
  awaiting_partner_confirmation: ["assigned", "cancelled"],
  scheduled: ["assigned", "cancelled"],
  assigned: ["tech_en_route", "cancelled"],
  tech_en_route: ["arrived", "in_progress", "cancelled"],
  arrived: ["inspection_started", "in_progress", "cancelled"],
  inspection_started: ["quote_submitted", "in_progress", "cancelled"],
  ...
  quote_approved: ["repair_started", "in_progress", "completed", "cancelled"],
  quote_rejected: ["quote_revised", "cancelled"],
  repair_started: ["completed", "cancelled"],
  completed: ["rated"],
  rated: [],
  cancelled: [],
};
