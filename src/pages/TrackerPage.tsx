...
function getMascotKey(status: string, sosActive: boolean): MascotMessageKey {
  ...
  switch (status) {
    case "requested": return "welcome";
    case "scheduled": return "welcome";
...
const TrackerPage = () => {
  ...
  const handlePayDeposit = () => {
    setPayment(booking.jobId, "deposit", {
      ...
      method: "cash",
      status: "paid",
      refundableAmount: booking.pricing.depositAmount,
      refundStatus: "none",
      ...
      <main className="flex-1 bg-background">
        <div className="container py-8 max-w-2xl">
          ...
          <div className="flex items-start justify-between mb-4">
            ...
            <div className="flex flex-col items-end gap-1">
              ...
              {booking.etaMinutes && booking.dispatchStatus === "dispatched" && (
                <span className="text-[10px] text-muted-foreground">ETA ~{booking.etaMinutes} min</span>
              )}
            </div>
          </div>
          ...
          <div className="bg-card rounded-xl border p-4 mb-4 space-y-2 animate-fade-in">
            ...
            {booking.dispatchStatus === "dispatched" && (
